...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/framework`,         lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${BASE}/tools`,             lastModified: new Date(), changeFrequency: "monthly", priority: 0.65 },
    { url: `${BASE}/tools/ai-detector`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.55 },
