...
const COLOR = "#A78BFA";
const DESC = "Evidence and improve your parental engagement strategy. Track communication channels, involvement in school life, and demonstrate impact for Ofsted.";

export default function ParentalEngagementPage() {
  return (
    <div className="min-h-screen pt-20 pb-16" style={{ background: "var(--bg)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <ToolPageHeader slug="parental-engagement" icon={Users} badge="Engagement" title="Parental Engagement Tracker" description={DESC} color={COLOR} />
        <GlassCard>
