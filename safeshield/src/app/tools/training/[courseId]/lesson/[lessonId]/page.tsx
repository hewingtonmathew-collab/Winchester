    ...
    async function load() {
      ...
      try {
        ...
        if (user) {
          ...
          // Check if this lesson already completed (auto-show quiz results)
          const thisLessonProg = (prog ?? []).find(
            (p: TrainingProgress) => p.lesson_id === lessonId && p.completed
          );
          if (thisLessonProg && (quizData ?? []).length > 0) {
            setSubmitted(true);
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
            ...
            <div className="lg:col-span-3 flex flex-col gap-5">
              ...
              {courseComplete && (
                <GlassCard className="text-center py-10">
                  ...
                  <p className="text-sm mb-6" style={{ color: "var(--text-muted)" }}>
                    You have completed all lessons. Your certificate is ready.
                  </p>
                  <Link
              ...
              {/* Quiz section */}
              {lesson.has_quiz && quizzes.length > 0 && (
                <GlassCard>
