...
const COLOR = "#38BDF8";
const DESC = "Track and manage Subject Access Requests under UK GDPR. Automated deadline tracking, response templating, and compliance reporting.";

export default function SarTrackerPage() {
  return (
    <div className="min-h-screen pt-20 pb-16" style={{ background: "var(--bg)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <ToolPageHeader slug="sar-tracker" icon={FileSearch} badge="SAR" title="Subject Access Request Tracker" description={DESC} color={COLOR} />
        <GlassCard>
          <div className="text-center py-12">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: COLOR + "18", border: `1px solid ${COLOR}35` }}>
              <FileSearch size={28} style={{ color: COLOR }} />
            </div>
