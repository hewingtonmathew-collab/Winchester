      ...
      <GlassCard>
        ...
        <div className="flex items-center gap-3 mt-6 pt-5 border-t border-white/5">
          {activeCategory !== categories[categories.length - 1] ? (
            ...
            <button onClick={() => { const lbl = score >= 80 ? "Strong" : score >= 55 ? "Developing" : "Requires Improvement"; const rc = score >= 80 ? "#22c55e" : score >= 55 ? "#f59e0b" : "#ef4444"; setSubmitted(true); saveSubmission({ tool: "Governance Compliance Checker", ...meta, score, rating: lbl, ratingColor: rc, areas }); }} disabled={answered < items.length}
