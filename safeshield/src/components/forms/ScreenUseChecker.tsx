...
const TOOL_NAME = "Screen Use & Wellbeing Review";
...
const questions: Question[] = [
  // Educational Benefit
  { id: "q1",  category: "Educational Benefit",          text: "Is screen use linked to clear educational outcomes and curriculum intent?",                                                                  weight: 10 },
  { id: "q2",  category: "Educational Benefit",          text: "Are teachers selecting digital tools based on evidence of educational impact rather than novelty?",                                         weight: 9  },
  { id: "q3",  category: "Educational Benefit",          text: "Is there a school-wide approach to evaluating whether screen use improves learning outcomes?",                                               weight: 8  },
  { id: "q4",  category: "Educational Benefit",          text: "Are pupils able to explain the educational purpose of screen-based activities they undertake?",                                              weight: 7  },
  // Screen Exposure & Physical Health
  { id: "q5",  category: "Screen Exposure & Physical Health", text: "Does the school monitor and manage cumulative screen time across the school day?",                                                      weight: 9  },
  { id: "q6",  category: "Screen Exposure & Physical Health", text: "Are regular screen breaks built into lessons involving extended device use?",                                                           weight: 8  },
  { id: "q7",  category: "Screen Exposure & Physical Health", text: "Is physical activity incorporated to offset periods of sedentary screen use?",                                                         weight: 8  },
  { id: "q8",  category: "Screen Exposure & Physical Health", text: "Are staff aware of UK Chief Medical Officers' guidance on screen time and physical health?",                                           weight: 7  },
  // Sleep & Wellbeing
  { id: "q9",  category: "Sleep & Wellbeing",            text: "Does the school provide age-appropriate guidance to parents on evening screen use and sleep hygiene?",                                       weight: 9  },
  { id: "q10", category: "Sleep & Wellbeing",            text: "Are pupils educated about the impact of blue light and social media use on sleep quality?",                                                  weight: 8  },
  { id: "q11", category: "Sleep & Wellbeing",            text: "Is there a policy restricting device use at break times, lunchtimes or after school to protect wellbeing?",                                  weight: 7  },
  { id: "q12", category: "Sleep & Wellbeing",            text: "Does the school monitor and respond to pupil wellbeing concerns linked to screen or social media use?",                                      weight: 9  },
  // Age Suitability & SEND
  { id: "q13", category: "Age Suitability & SEND",       text: "Are digital tools and content verified as age-appropriate before use with pupils?",                                                          weight: 10 },
  { id: "q14", category: "Age Suitability & SEND",       text: "Are SEND pupils' individual needs considered when deploying screen-based learning tools?",                                                   weight: 9  },
  { id: "q15", category: "Age Suitability & SEND",       text: "Are assistive technologies and accessibility settings used where appropriate for SEND learners?",                                            weight: 8  },
  { id: "q16", category: "Age Suitability & SEND",       text: "Are parents and carers of SEND pupils consulted about appropriate screen use at home?",                                                      weight: 7  },
  // Governance & Parental Engagement
  { id: "q17", category: "Governance & Parental Engagement", text: "Does the school have a written Screen Use Policy reviewed within the last 12 months?",                                                  weight: 9  },
  { id: "q18", category: "Governance & Parental Engagement", text: "Are governors regularly briefed on the school's approach to screen use and digital wellbeing?",                                         weight: 7  },
  { id: "q19", category: "Governance & Parental Engagement", text: "Is screen use guidance shared with parents at least annually?",                                                                         weight: 7  },
  { id: "q20", category: "Governance & Parental Engagement", text: "Does the school participate in national campaigns such as Safer Internet Day to raise digital awareness?",                              weight: 6  },
];
...
function getRating(score: number): { label: string; color: string } {
  if (score >= 75) return { label: "Good Practice", color: "#22c55e" };
  if (score >= 50) return { label: "Developing",    color: "#f59e0b" };
  return { label: "Requires Review", color: "#ef4444" };
}
        ...
        <GlassCard glow className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#94A3B8] text-sm leading-relaxed max-w-md">
              {score >= 75
                ? "Your school demonstrates good practice around screen use and digital wellbeing. Continue reviewing policies annually and monitoring pupil wellbeing."
                : score >= 50
                ? "Your school is developing its approach to screen use and wellbeing. Address the priority gaps below to strengthen provision."
                : "Significant gaps identified in screen use governance and pupil wellbeing. Immediate action is required across multiple areas."}
            </p>
          </div>
        </GlassCard>
