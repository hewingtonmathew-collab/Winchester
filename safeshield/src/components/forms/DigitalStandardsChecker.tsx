...
export default function DigitalStandardsChecker() {
  ...
  function submit() {
    setSubmitted(true);
    saveSubmission({ tool: "Digital Standards Checker", ...meta, score, rating, ratingColor: ringColor });
  }
  ...
  if (submitted) {
    return (
      <div className="flex flex-col gap-5">
        ...
        <Certificate meta={meta} toolName="Digital Standards Checker" score={score} rating={rating} ratingColor={ringColor} accentColor={COLOR} areas={TABS.map(tab => {
