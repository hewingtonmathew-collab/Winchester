...
export default function ImprovementReport({
  ...
  function buildEmailBody() {
    const lines = [
      ...
      "",
      "Generated by SafeShield Tools · Winchester Consultancy",
    ];
      ...
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        <div class="meta-grid">
          ...
          <div class="meta-item"><label>Consultant</label>${meta.consultantName}, Winchester Consultancy</div>
        </div>
        ...
        <h2>Next Steps</h2>
        <p>Winchester Consultancy recommends that ${meta.schoolName} addresses the high-priority actions within 30 days and schedules a follow-up review within 3 months. The consultant named above is available to provide targeted support across all identified areas.</p>

        <div class="footer">
          <span>Generated by SafeShield Tools · Winchester Consultancy</span>
          <span>${today}</span>
        </div>
      </body></html>
    `);
